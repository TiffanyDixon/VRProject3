...
function setMode(n){
	switch(n){
		case 1: // LORI D
			...
			origColor = GetComponent.<Renderer>().material.color = Color(v,v,v);
			break;
		case 2:	// REDINHO
			origColor = GetComponent.<Renderer>().material.color = new Color(Random.Range(0.7,1.0), 0 , Random.Range(0.0,1.0));
			break;
		case 3: // COLOR
			origColor = GetComponent.<Renderer>().material.color = new Color(Random.Range(0.0,1.0), Random.Range(0.0,1.0) , Random.Range(0.0,1.0));
			break;
		default:
			origColor = GetComponent.<Renderer>().material.color = matAr[playMode];
			break;	
	}	
}
...
function blink(){
	...
	GetComponent.<Renderer>().material.color =  origColor * n;
}
